...
TYPES_FOR_RAW_PACKET_LOGGING = [
    ...
    LOG_NR_NAS_5GSM_PLAIN_OTA_IN_MSG_LOG_C, # 0xb800
    LOG_NR_NAS_5GSM_PLAIN_OTA_OUT_MSG_LOG_C, # 0xb801

    LOG_NR_NAS_5GSM_SEC_OTA_IN_MSG_LOG_C, # 0xb808
    LOG_NR_NAS_5GSM_SEC_OTA_OUT_MSG_LOG_C, # 0xb809

    LOG_NR_NAS_5GMM_PLAIN_OTA_IN_MSG_LOG_C, # 0xb80a
    LOG_NR_NAS_5GMM_PLAIN_OTA_OUT_MSG_LOG_C, # 0xb80b

    LOG_NR_NAS_5GMM_PLAIN_OTA_CONTAINER_MSG_LOG_C, # 0xb814
    # TODO Other 5G-related logs?
