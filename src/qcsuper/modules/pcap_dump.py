    ...
    def on_log(self, log_type, log_payload, log_header, timestamp=0):
        ...
        if log_type == WCDMA_SIGNALLING_MESSAGE:  # 0x412f
            ...
            if channel_type in (
                ...
                0x89,
                0xF0,
                RRCLOG_EXTENSION_SIB,
                RRCLOG_SIB_CONTAINER,
            ):
            ...
            packet = build_gsmtap_ip(
                GSMTAP_TYPE_UMTS_RRC, gsmtap_channel_type, packet, is_uplink
            )
            ...
            packet = build_gsmtap_ip(
                interface_type, gsmtap_channel_type, packet, is_uplink
            )
            ...
            packet = build_gsmtap_ip(
                GSMTAP_TYPE_UM, gsmtap_channel_type, packet, is_uplink
            )
            ...
            packet = build_gsmtap_ip(
                GSMTAP_TYPE_LTE_RRC, gsmtap_channel_type, packet, is_uplink
            )
